...
## Версия Windows
есть еще и [![Android](https://img.shields.io/badge/Android-green?logo=android)](android/README.md)

--------------
### Виндовс приложение для поиска в локальной сети и отображения вебморды устройств
...
+ Home Assistant
+ любых устройсв с доступным веб интерфейсом
